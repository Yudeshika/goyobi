...
import '../../screens/customer/show.dart';
import '../../screens/policy/life/show.dart';
import '../../screens/policy/motor/show.dart';
import '../../screens/policy/fire/show.dart';
import '../../screens/policy/dta/show.dart';
import '../../screens/policy/title/show.dart';
import '../../screens/policy/medical/show.dart';
...
class ListingState<T extends StatefulWidget> extends State<T>
  ...
  Widget build(BuildContext context) {
    ...
    List<Widget> icons = [
      ...
      Text(
        "DTA",
        style: new TextStyle(color: foregroundColor, fontSize: 13.0),
      ),
    ...
    return new Scaffold(
        ...
        floatingActionButton: (this.table != "policies")
            ? IMButton(
                title: "",
                ...
                onPressed: () {
                  Navigator.of(context).pushNamed(
                      '/' + table.substring(0, table.length - 1) + 'create');
                },
                              ...
                              if (table == "policies") {
                                switch (index) {
                                  case 0: //Life
                                    Navigator
                                        .of(context)
                                        .pushNamed('/policylifecreate');
                                    break;
                                  case 1: //Motor
                                    Navigator
                                        .of(context)
                                        .pushNamed('/policymotorcreate');
                                    break;

                                  case 2: //Fire
                                    Navigator
                                        .of(context)
                                        .pushNamed('/policyfirecreate');
                                    break;

                                  case 3: //DTA
                                    Navigator
                                        .of(context)
                                        .pushNamed('/policydtacreate');
                                    break;

                                  case 4: //Title
                                    Navigator
                                        .of(context)
                                        .pushNamed('/policytitlecreate');
                                    break;

                                  case 5: //Medical
                                    Navigator
                                        .of(context)
                                        .pushNamed('/policymedicalcreate');
                                    break;

                                  case 6: //Retirement
                                    Navigator
                                        .of(context)
                                        .pushNamed('/policyretirementcreate');
                                    break;
                                }
                              }
                            },
                                                    ...
                                                    ? new Container(
                                                        ...
                                                        child: new Text(
                                                            document['bday']
                                                                ...
                                                                "(" +
                                                                (now.year -
                                                                        int.tryParse(document['bday'].split("-")[
                                                                            0]))
                                                                    .toString() +
                                                                ")",
                                                            style: TextStyle(
                                    ...
                                    : (this.table == "policies")
                                        ...
                                        : IMListTile(
                                            ...
                                            title: document[this.columns[0]]
                                                .toString(),
                                            subtitle: document[this.columns[1]]
                                                    .toString() +
      ...
      child: ListTile(
          ...
          onLongPress: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => PolicyLifeView(document),
              ),
            );
          },
          ...
          subtitle: new Column(
            ...
            children: <Widget>[
              ...
              new Row(children: <Widget>[
                ...
                (document['premium'] != '')
                    ? new Container(
                        width: 60.0, child: new Text(document['premium']))
                ...
                (document['policyperiod'] != '')
                    ? new Container(
                        width: 100.0, child: new Text(document['policyperiod']))
      ...
      child: ListTile(
          ...
          onLongPress: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => PolicyMotorView(document),
              ),
            );
          },
            ...
            children: <Widget>[
              ...
              new Row /*or Column*/ (
                ...
                children: <Widget>[
                  ...
                  (document['start'] != '')
                      ? new Container(child: new Text(document['start']))
                      : new SizedBox(width: 60.0),
                ],
              ),
              new Row(
      ...
      child: ListTile(
          ...
          onLongPress: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => PolicyFireView(document),
              ),
            );
          },
          title: new Text(document['policyno']),
      ...
      child: ListTile(
          ...
          onLongPress: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => PolicyDtaView(document),
              ),
            );
          },
          title: new Text(document['policyno']),
      ...
      child: ListTile(
          ...
          onLongPress: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => PolicyTitleView(document),
              ),
            );
          },
          title: new Text(document['policyno']),
      ...
      child: ListTile(
          ...
          onLongPress: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => PolicyMedicalView(document),
              ),
            );
          },
          title: new Text(document['name']),
            ...
            children: <Widget>[
              ...
              new Row /*or Column*/ (
                ...
                children: <Widget>[
                  ...
                  (document['premium'] != '')
                      ? new Container(child: new Text(document['premium']))
                      : new SizedBox(width: 60.0),
                ],
              ),
              new Row(
            ...
            children: <Widget>[
              ...
              new Row /*or Column*/ (
                ...
                children: <Widget>[
                  ...
                  (document['end'] != '')
                      ? new Container(child: new Text(document['end']))
                      : new SizedBox(width: 60.0),
                ],
              ),
              new Row(
