...
class GenderIconTranslated extends StatelessWidget {
  static final Map<Gender, String> _genderImages = {
    Gender.female: "assets/tools/bmi/gender_female.svg",
    Gender.other: "assets/tools/bmi/gender_other.svg",
    Gender.male: "assets/tools/bmi/gender_male.svg",
  };
    ...
    return Transform.rotate(
      ...
      child: Transform.translate(
        ...
        child: Transform.rotate(
          ...
          child: SvgPicture.asset(
            "assets/tools/bmi/gender_arrow.svg",
