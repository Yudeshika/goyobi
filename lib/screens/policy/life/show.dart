...
class PolicyLifeView extends StatefulWidget {
  ...
  @override
  _PolicyLifeViewState createState() => new _PolicyLifeViewState();
}

class _PolicyLifeViewState extends State<PolicyLifeView> {
