...
class PolicyTitleView extends StatefulWidget {
  ...
  @override
  _PolicyTitleViewState createState() => new _PolicyTitleViewState();
}

class _PolicyTitleViewState extends State<PolicyTitleView> {
